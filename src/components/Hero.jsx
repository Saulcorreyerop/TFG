...
const Hero = () => {
    ...
    return (
        <main className="hero-bg flex flex-column align-items-center justify-content-center text-center relative" style={{minHeight: '85vh'}}>
            <div className="hero-content z-1 p-4" style={{maxWidth: '900px'}}>
                {/* Texto Blanco Puro y Sombra suave para resaltar sobre la imagen */}
                <h1 className="text-6xl font-bold mb-3 text-white" style={{textShadow: '0 2px 10px rgba(0,0,0,0.5)'}}>
                ...
                <p className="text-xl text-100 mb-6 line-height-3 font-medium">
                    Únete a la mayor comunidad de motor en España. Localiza KDDs, gestiona tu garaje y conecta con otros apasionados.
                </p>
            ...
            <Dialog header="Únete a CarMeet ESP" visible={visible} style={{ width: '90vw', maxWidth: '400px' }} onHide={() => setVisible(false)}>
                <div className="flex flex-column gap-3">
                    <p className="m-0">Introduce tu correo para recibir alertas de eventos cercanos.</p>
                    <span className="p-input-icon-left">
                        <i className="pi pi-envelope" />
                        <InputText placeholder="tu@email.com" className="w-full" />
                    </span>
                    <Button label="Continuar" icon="pi pi-arrow-right" autoFocus onClick={() => setVisible(false)} />
                </div>
            </Dialog>
        </main>
    );
