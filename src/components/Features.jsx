    ...
    <section id='features' className='py-8 px-4 relative z-10'>
      <div className='max-w-7xl mx-auto'>
        ...
        >
              ...
              <div className='relative z-1 p-5 md:p-6 flex flex-column flex-1'>
                ...
                <div className='mt-auto bg-black-alpha-30 backdrop-blur-md border-round-3xl p-4 flex align-items-center justify-content-between border-1 border-white-alpha-20 shadow-4'>
                  <div className='flex align-items-center gap-4'>
                    <div className='w-3rem h-3rem bg-orange-500 text-white border-circle flex align-items-center justify-content-center shadow-2 flex-shrink-0'>
          ...
          {/* Feature 3: NUEVO Bento Morado (Crews) */}
          <MotionDiv variants={itemVars} className='col-12 lg:col-5 p-3'>
            <div
              className='bento-card bento-purple relative group flex flex-column h-full cursor-pointer'
              onClick={() =>
            ...
            >
              ...
              <div className='relative z-1 p-5 md:p-6 flex flex-column flex-1'>
                ...
                <p className='text-white-alpha-90 text-xl line-height-4 font-medium mb-6'>
                  Crea tu propia familia del motor. Gestiona solicitudes, añade
                  miembros y presume de los vehículos oficiales del club.
                </p>

                <div className='mt-auto bg-black-alpha-30 backdrop-blur-md border-round-3xl p-4 flex align-items-center gap-4 border-1 border-white-alpha-20 shadow-4'>
                  <div className='w-3rem h-3rem bg-purple-500 text-white border-circle flex align-items-center justify-content-center shadow-2 flex-shrink-0'>
                    <ShieldCheck size={20} strokeWidth={3} />
                  </div>
                  <div>
                    <div className='text-white font-black text-lg line-clamp-1'>
                      Petición Aceptada
                    </div>
                    <div className='text-white-alpha-70 font-medium text-sm mt-1'>
          ...
          {/* Feature 4: Bento Oscuro (Garaje) ajustado a col-7 */}
          <MotionDiv variants={itemVars} className='col-12 lg:col-7 p-3'>
            <div
              className='bento-card bento-dark relative group overflow-hidden h-full cursor-pointer'
            ...
            >
              ...
              <div className='relative z-1 p-5 md:p-7 flex flex-column xl:flex-row align-items-center gap-6 h-full'>
                <div className='flex-1 w-full xl:w-auto z-2'>
                  <div className='glass-icon-box'>
                ...
                <div className='flex-1 w-full relative h-15rem md:h-20rem bg-white-alpha-10 border-round-3xl border-2 border-white-alpha-20 flex align-items-center justify-content-center overflow-hidden backdrop-blur-sm mt-5 xl:mt-0'>
                  ...
                  <div
                    className='mockup-img-card right-card absolute w-12rem md:w-16rem h-16rem md:h-20rem border-round-3xl overflow-hidden z-1 transform -rotate-12 mr-4 right-0 md:right-auto md:mr-0 mt-6'
